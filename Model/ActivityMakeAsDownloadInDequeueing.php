...
class ActivityMakeAsDownloadInDequeueing
{
    /**
    ...
    public function execute(int $activityId)
    {
        ...
        if ($activity->getStatus() !== ActivityStateInterface::DOWNLOAD_IN_DEQUEUING) {
            $activity->setStatus(ActivityStateInterface::DOWNLOAD_IN_DEQUEUING);
